...
import { ClipboardList, FileText, Droplets, Recycle, ChartNoAxesCombined, Sparkles, ShieldCheck, ArrowRight } from 'lucide-react'
import { services } from '@/lib/services'

const icons = [ClipboardList, FileText, Droplets, Recycle, ChartNoAxesCombined, Sparkles, ShieldCheck]
    ...
    <section id="services" className="py-20 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Consultoría Ambiental, Seguridad y Salud Ocupacional</h2>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">Servicios técnicos especializados para la gestión ambiental y la seguridad laboral de tu empresa.</p>
        </div>
