...
const images = {
  ...
  survey3: '/imagenes_emp/514248462_724367453529755_1591029788060971234_n.jpg',
...
export const services: Service[] = [
  ...
  { slug: 'planes-estudios-ambientales', title: 'Planes y Estudios Ambientales', shortDescription: 'Planes de manejo, vigilancia, contingencia y estudios de línea base ambiental.', description: 'Desarrollamos planes y estudios orientados a prevenir, controlar y mitigar impactos ambientales durante todo el ciclo de tu proyecto.', image: images.survey, gallery: [images.survey, images.survey2, images.survey3], details: ['Planes de Manejo de Residuos Sólidos y Estrategia Ambiental', 'Programas de Vigilancia Ambiental y Participación Social', 'Planes de Cierre, Abandono y Contingencias', 'Estudios de Riesgos y Vulnerabilidad Ambiental', 'Líneas Base Ambiental y Social para Estudios y Proyectos'] },
